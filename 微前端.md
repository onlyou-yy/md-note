...
if (window.__POWERED_BY_QIANKUN__) {
  // 在 webpack 项目中如果在配置中没有配置 publicPath （加载资源的基础路径）那么就会在全局中查找和使用 __webpack_public_path__ 变量，这样再qiankun中加载项目的时候就可以通过 __webpack_public_path__ 变量动态设置子应用的基础资源路径
...
[手写 qiankun 微前端框架](https://www.bilibili.com/video/BV1H34y117fe/?spm_id_from=333.337.search-card.all.click&vd_source=41ed998ac767425fb616fd9071ce9682)

https://github.com/onlyou-yy/mini-qiankun#
...
之后修改`webpack.config.js`，将`Header.js`导出给别人使用
